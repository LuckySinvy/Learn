...
<Callout type="tip" title="🤖 AI 时代，为什么还要学 MongoDB？">
AI 生成的文档结构往往是扁平且随意的，但真正决定查询性能的是你怎么建模——哪些字段内嵌、哪些用引用、分片键怎么选。MongoDB 的灵活文档模型适合快速迭代与半结构化数据，正是 AI 产物（向量、会话、中间结果）天然的存储底座。理解建模与索引原理，才能把 AI 吐出的数据可靠地存下来、查得出来。
</Callout>
