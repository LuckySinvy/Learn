...
<Callout type="tip" title="🤖 AI 时代，为什么还要学 TypeScript？">
AI 写的 TS 可能类型宽松、充满 `any`，而类型才是 TypeScript 的精髓——类型即文档，类型即护栏。只有你理解类型系统，才能让编辑器精准补全、让重构安全，把错误挡在编译期而非线上。把类型用扎实，你就能把 AI 当作一个懂你契约的协作者。
</Callout>
