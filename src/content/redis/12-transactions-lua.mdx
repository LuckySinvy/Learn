...
(integer) 2
# KEYS 数组传 key, ARGV 数组传参数; numkeys 声明 key 个数
127.0.0.1:6379> EVAL "return redis.call('SET', KEYS[1], ARGV[1])" 1 greeting "hello"
OK
...
```bash
$ redis-cli SET stock:sku:2001 5
OK
$ redis-cli EVAL "$(cat deduct.lua)" 1 stock:sku:2001 2
(integer) 3
$ redis-cli EVAL "$(cat deduct.lua)" 1 stock:sku:2001 9
(integer) -1            # 库存不足, 拒绝, 且绝不会超卖
```
...
"a5260dd66ce02462c5b5e49a19df58c1f438d81a"
127.0.0.1:6379> EVALSHA a5260dd66ce02462c5b5e49a19df58c1f438d81a 1 greeting
"hello"
127.0.0.1:6379> SCRIPT EXISTS a5260dd66ce02462c5b5e49a19df58c1f438d81a
1) (integer) 1
```
