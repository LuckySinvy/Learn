...
```bash
127.0.0.1:6379> HSET user:1001 name "Ada" age 30 city "Shanghai"
(integer) 3             # 新建的 field 数量
127.0.0.1:6379> HGET user:1001 name
"Ada"
127.0.0.1:6379> HMGET user:1001 name age nonexist
1) "Ada"
2) "30"
3) (nil)
...
```bash
127.0.0.1:6379> HINCRBY user:1001 balance 100
(integer) 100
127.0.0.1:6379> HINCRBY user:1001 balance -30
(integer) 70
...
```bash
# 购物车是 Hash 的经典场景: field=商品ID, value=数量
127.0.0.1:6379> HSET cart:u1001 sku:2001 1 sku:2002 3
(integer) 2
127.0.0.1:6379> HINCRBY cart:u1001 sku:2001 1     # 商品数量 +1
(integer) 2
127.0.0.1:6379> HDEL cart:u1001 sku:2002          # 移除商品
(integer) 1
127.0.0.1:6379> HGETALL cart:u1001                # 结算时取整车
1) "sku:2001"
2) "2"
```
