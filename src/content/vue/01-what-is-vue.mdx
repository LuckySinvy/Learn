...
<Callout type="tip" title="🤖 AI 时代，为什么还要学 Vue？">
AI 能拼出 Vue 组件，却常搞不清响应式的依赖边界——哪些状态该用 `ref`、哪些该 `computed`、副作用该放哪。Vue 的响应式系统让你只描述数据与界面的关系，剩下的同步交给框架，这正是它生产力的来源。读懂这套机制，你才能让 AI 生成的代码真正贴合 Vue 的响应式心智模型。
</Callout>
